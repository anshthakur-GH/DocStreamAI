...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-3xl border-b border-white/60 dark:border-slate-800/60 shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-28 relative">
          ...
          <Link to="/dashboard" className="flex items-center space-x-2 z-10">
            <span className="text-3xl font-black tracking-tighter text-blue-600 dark:text-blue-400 uppercase">
              Unfazed <span className="text-slate-900 dark:text-white">DocStream AI</span>
            </span>
          </Link>
